package space.ravisu.example.lookupclient.ui.messenger
...
import space.ravisu.example.lookupclient.*
import space.ravisu.example.lookupclient.databinding.FragmentMessengerBinding
...
class MessengerFragment : Fragment(), ServiceConnection, View.OnClickListener {
    ...
    private fun doBindService() {
        ...
        Intent("messengerexample").also { intent ->
            intent.`package` = "space.ravisu.example.lookupservice"
